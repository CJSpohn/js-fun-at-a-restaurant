...
var vegetables = ["carrot", "broccoli", "onion", "spinach", "bean sprout"];
...
// different fruits.
var fruits = ["apple", "banana", "orange", "mango", "kiwi", "plum", "grapefruit"]
...
//Other sensisble key value pairs could be `address: "123 street dr"` or `weeklySaleItems = ["take out pizzas",
//"two for one steaks", "other sale things"]`
